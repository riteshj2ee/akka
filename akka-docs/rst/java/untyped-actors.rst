...
.. warning::
  ...
  Please note that the ``UntypedActorWithStash can only be used together
  with actors that have a deque-based mailbox. For this, configure the
